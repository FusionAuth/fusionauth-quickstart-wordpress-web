            ...
            <div class="wowp-header">
                <div class="wowp-logo">
                    <img src="<?php echo esc_url( $logo_url ); ?>"
                         alt="<?php echo esc_attr( WOW_Plugin::NAME ); ?> logo">
                </div>
                <h1><?php echo esc_html( WOW_Plugin::NAME ); ?> <sup
                            class="wowp-version"><?php echo esc_html( WOW_Plugin::VERSION ); ?></sup></h1>
                <a href="<?php echo esc_url( $add_url ); ?>"
                   class="button"><?php esc_html_e( 'Add New', 'wpcoder' ); ?>
                </a>
